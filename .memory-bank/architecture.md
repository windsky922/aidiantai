...
- `src/components/InfoPanel.tsx` exposes draft generation in Settings.
...
- Do not let draft generation directly overwrite the active player episode until an explicit promote/apply flow exists.
